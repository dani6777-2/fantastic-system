  ...
  return (
    <div className="container mx-auto p-4">
      ...
      {selectedProviders.length > 0 && (
                    ...
                    <CardContent className="comparison-card-content">
                        <div className="flex justify-center mb-4">
                            <Image
                                ...
                                alt={`${comparisonData[provider as keyof typeof comparisonData].name} Logo`}
                                width={150}
                                height={60}
        ...
        <div className="mt-12">
            <h2 className="section-title">
                Comparación de Infraestructura Global
            </h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {selectedProviders.map((provider) => (
                    <Card key={provider} className="comparison-card">
                        ...
                        <CardContent className="comparison-card-content">
                            <CardDescription className="comparison-card-description">{infraestructuraGlobalData[provider as keyof typeof infraestructuraGlobalData]}</CardDescription>
                        </CardContent>
                    </Card>
                ))}
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {selectedProviders.map((provider) => (
                    <Card key={provider} className="comparison-card">
                        ...
                        <CardContent className="comparison-card-content">
                            <CardDescription className="comparison-card-description">{preciosYModeloFacturacionData[provider as keyof typeof preciosYModeloFacturacionData]}</CardDescription>
                        </CardContent>
                    </Card>
                ))}
            </div>
        ...
        <div className="mt-12">
            <h2 className="section-title">Servicios Clave Ofrecidos</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {selectedProviders.map((provider) => (
                    <Card key={provider} className="comparison-card">
                        <CardHeader className="comparison-card-header">
                        ...
                        <CardContent className="comparison-card-content">
                            <CardDescription className="comparison-card-description">{serviciosClaveData[provider as keyof typeof serviciosClaveData]}</CardDescription>
                        </CardContent>
                    </Card>
                ))}
            </div>
        ...
        <div className="mt-12">
            <h2 className="section-title">Nuestras Opiniones</h2>
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {selectedProviders.map((provider) => (
                    <Card key={provider} className="comparison-card">
                        <CardHeader className="comparison-card-header">
                        ...
                        <CardContent className="comparison-card-content">
                            <CardDescription className="comparison-card-description">{comparisonData[provider as keyof typeof comparisonData].opinion}</CardDescription>
                        </CardContent>
                    </Card>
                ))}
            </div>
            ...
            <div className="mt-12">
                <h2 className="section-title">Mi Opinión Personal</h2>
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {selectedProviders.map((provider) => (
                        <Card key={provider} className="comparison-card">
                            <CardHeader className="comparison-card-header">
                            ...
                            <CardContent className="comparison-card-content">
                                <CardDescription className="comparison-card-description">{miOpinion[provider as keyof typeof miOpinion]}</CardDescription>
                            </CardContent>
                        </Card>
                    ))}
                </div>
